...
public class Teclado extends JPanel implements ActionListener {
	...
	private final static Color COR_CINZA_ESCURO = new Color(68, 68, 68);
	private final static Color COR_CINZA_CLARO = new Color(99, 99, 98);
	private final static Color COR_LARANJA = new Color(242, 163, 60);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() instanceof JButton) {
			...
			Memoria.get().processarComando(botao.getText());
		}
	}
}
